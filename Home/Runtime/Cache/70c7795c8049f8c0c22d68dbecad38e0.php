...
<div id="header">	
			...
			<div class="inner">
                ...
                <div id="top-nav">
					...
					<!--<div class="menu-menu-container"><ul id="menu-menu" class="menu"><li><a href="<?php echo U('Index/index');?>">PHP</a></li>-->
...
<!--<li><a href="http://pan.baidu.com/share/link?shareid=548956950&uk=1846304022" target='_blank'>MYSQL</a></li>-->
<li><a href="<?php echo U('Feedback/index');?>">JS</a></li>
</ul></div>                                    
				</div>
		...
		<div id="content" class="clearfix">
			...
			<div id="content-wrap" class="clearfix">
				...
				<div id="primary" class="hfeed">
                		...
                		<!--Position-->
						<div class="clearfix" style="margin-bottom:5px"><img src="__IMG__/home.png" width='18' height='16' alt='个人博客' />&nbsp;<?php echo ($position); ?></div>
...
<span class="recentcommentsavatar"><img alt='个人博客' src='__IMG__/logo_03.jpg' class='avatar' height='32' width='32' /></span>
...
<div id="footer">
			...
			<div id="footer-texture">
				...
				<div id="footer-inner">
                   ...
                   由RUIblog二次开发而来<br/>
                    Copyright 2015  <a href="/"><?php echo (C("CFG_POWERBY")); ?></a> All rights reserved.&nbsp;

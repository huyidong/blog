...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <form name="form1" action="__URL__/update" method="post">
	<input type="hidden" value="<?php echo ($data["colid"]); ?>" name="colid"/>
    <td height="95" align="center" bgcolor="#FFFFFF">
        ...
        <table width="100%" border="0"  id="needset" cellspacing="0" cellpadding="0" style="text-align:left;border:1px solid #cfcfcf;background:#ffffff;">
          ...
          <tr>
            ...
            <td class='bline'>
                <input type='radio' name='isshow' value='1' class='np' <?php if($data['isshow'] == 1) echo "checked='checked'"; ?> />
              显示　&nbsp;
              <input type='radio' name='isshow' value='0' class='np' <?php if($data['isshow'] == 0) echo "checked='checked'"; ?> />
              隐藏
             </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class='bline'><input name="colname" type="text" id="typename" size="30" class="iptxt" value="<?php echo ($data["colname"]); ?>"/></td>
          </tr>
          
          <tr>
            <td class='bline' height="26" style="padding-left:10px;"> 排列顺序： </td>
            <td class='bline'><input name="ord" size="6" type="text" value="<?php echo ($data["ord"]); ?>" class="pubinputs" style="width:60px" /></td>
          </tr>
          ...
          <tr >
            ...
            <td bgcolor="#F3F7EA">
             <textarea name="description" style="height:60px"  cols="60"><?php echo ($data["description"]); ?></textarea>
            </td>
          </tr>     
        </table>
  ...
  <tr>
      <td height="24" colspan="2" class="bline">
        ...
        <tr>
          ...
          <td width="241">
          	  <input type="text" name="seo" id="seoid" size="40" value="<?php echo ($data["seo"]); ?>"/>                           
				  </td>
    ...
    <tr>
      <td height="24" colspan="2" class="bline">
        ...
        <tr>
          <td width="50">&nbsp;关键字：</td>
          <td width="241">
          	  <input type="text" name="keyword" id="keywordid" size="40" value="<?php echo ($data["keyword"]); ?>"/>                           
				  </td>
